...
db_teste = (datapath+dbfile1)
db_blog = (datapath+dbfile2)
rssblogoutput = (datapath+outblog)
usedb = True #False


# Aqui comeca o bloco de funcoes de extracao de features
...
# Aqui termina o bloco de funcoes de extracao de features
# Aqui termina o bloco de funcoes de classificacao
...
# Aqui termina o bloco de funcoes de classificacao
# Aqui comeca o bloco de funcoes de leitura de feed
...
def blogread(assunto,classifier): #(feed,classifier) -->caso fosse arquivo e nao web
    ...
    url='http://www.google.com/search?q=%s&hl=pt-BR&tbm=blg&output=rss'%assunto
...
# Aqui termina o bloco de funcoes de leitura de feeds rss
# Aqui comeca o bloco de testes e demonstracoes
